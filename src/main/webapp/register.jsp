...
<div class="main">
	<div class="login_container">
		...
		<form action="Login?action=Res" class="form" id="form-2"
			  method="post">
			<div class="auth-form__header">
				...
				<a href="<c:url value="/Login.jsp"></c:url>" style="text-decoration: none;"><span class="auth-form__switch-btn js-form-register" > ĐăngNhập</span></a>
			</div>
			...
			<table>
				...
				<tr class="value_form">
					<td>*Email :</td>
					<td><input type="email" name ="email" class="auth-form__input auth-form__input-register" placeholder="Nhập địa chỉ email"></td>
			...
			<div class="g-recaptcha" data-sitekey="6LfRPLImAAAAAFIGYxE_k4y6sthv4Voca49FkhA1"></div>\
			<p id="errorCheck" style="color: red"></p>
			<div class="check">
	...
	window.onload = function (){
		...
		form.addEventListener("submit", function (event){
			...
			if (response){
				...
				error.innerHTML = "Vui lòng check";
			}
		});
	}
</script>
