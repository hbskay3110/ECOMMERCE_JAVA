<%@page import="dao.DetailProductDAO"%>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<form class="form-horizontal
									...
									action="<c:url value="/startbootstrap-sb-admin-2-master/ThemSuaXoaSanPham?chucNang=Sua"></c:url>"
									method="post">
									<div class="form-group">
										<label class="control-label col-sm-2" >Mã sản phẩm:</label>
										<div class="col-sm-10">
											<input  class="form-control" id="pwd" name="maSP" value="${sp.idP}">
										</div>
									...
									<div class="form-group">
										<label class="control-label col-sm-2" >Tên
											sản phẩm*:</label>
										<div class="col-sm-10"> 
											<input type="text" class="form-control" id="pwd" value="${sp.nameP}"
									...
									<div class="form-group">
										<label class="control-label col-sm-2" for="pwd">Giá
											gốc:</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${sp.priceP}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd"  value="${Math.round(sp.priceP-sp.priceP*(sp.sale/100))}"
								...
								<%-- 	<div class="form-group">
									...
									<div class="form-group">
										<label class="control-label col-sm-2" for="pwd">Ảnh
											sản phẩm:</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${sp.listImage.get(0).nameI}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ncc.vendorName}"
												name="nameSupplier">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.desciption}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.material}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.designs}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.origin}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.style}"
