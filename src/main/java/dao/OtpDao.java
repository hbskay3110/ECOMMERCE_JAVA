...
//
//public class OtpDao implements ObjectDAO {
//    public static Map<String, Otp> mapAccount = loadData();
//
//
//    public OtpDao() {
...
//    }
//
//    private static Map<String, Otp> loadData() {
//        Map<String, Otp> mapTemp = new HashMap<String, Account>();
////        try {
////            String query = "select * from CodeOTP";
